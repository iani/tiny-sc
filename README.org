...
** Object:src : Make any object receive messages from a data source.  Set or replace the origin of the data source at any time (Pattern/Stream, View, OSCFunc, MIDIFunc, constant).
