...
- Emacs: Eval code blocks between comments
- Emacs/org-mode:
...
Load entire org-mode files, selecting those sections which are not marked =disabled=.  This is good for configuring, for example the loading of groups of SynthDefs or soundfiles.
