...
// Set dur parameter of the pattern of the last chucked SynthTree
0.1 *> \dur;

// Again, this time a pattern:
[0.2, 0.6].pseq *> \dur;

// Set the instrument:
\sine *> \instrument;

// Set the instrument to a pattern.
[\lpfsaw, \sine].pseq *> \instrument;

// Also possible to address the SynthTree explicitly:
[instrument: [\lpfpulse, \werkitd].prand] => \test;
#+END_EXAMPLE
