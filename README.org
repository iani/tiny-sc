...
Settin other parameters of the synthree pattern merges these into the existing instrument pattern, leaving the instrument, duration or other parameters as they were:
#+BEGIN_EXAMPLE
