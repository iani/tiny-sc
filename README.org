...
The examples above show the syntax for parallel [] and serial () interconnections.  The
...
**** Linking to multiple inputs of one Chuck
:PROPERTIES:
:ID:       51712FCB-D988-472C-AB8E-B775DD24DF89
:eval-id:  7
:END:

Connect the reading Chuck instance in multiple serial branches, and use ":" as separator between chuck name and input name to indicate the name of the input.
