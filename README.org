...
- =H-<down>= :: next section at same level
- =H-C-<down>= :: next section at same level + evaluate
- =H-M-<down>= :: next section at same level + chuck
- =H-<up>= :: previous section at same level
- =H-C-<up>= :: previous section at same level + evaluate
- =H-M-<up>= :: previous section at same level + chuck
