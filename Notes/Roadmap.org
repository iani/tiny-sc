...
** Both single-synth andβ synth-stream should play with PatternInstrument
:PROPERTIES:
...
** DONE Fix bug: Restarting an ST in Fader view cancels its output routing.
