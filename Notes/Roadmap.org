...
Make Mdef (or new class: Edef) and SynthTree play with EventPattern instead of PatternEventPlayer.

Note: All inheritance should be done with Mdef or SynthTree.  Keep EventPattern, EventStream as simple as possible.
