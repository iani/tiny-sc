...
- Streams :: Used to store streams for global access.  Cannot respawn
- StreamPatterns :: Like streams, but can respawn their stream when ended.
- PatternPlayers :: Play patterns in time.
